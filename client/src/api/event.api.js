...
class EventApi{
    ...
    getEventQRCode = async (eventId) => {
        try {
            const response = await axios.get(`${this.baseUrl}/${eventId}/qrcode`, { withCredentials: true });
            return { success: true, message: response.data.message, data: response.data.data };
        } catch (error) {
            return { success: false, message: error.response?.data?.message || error.message, error };
        }
    ...
    getEventQRCodeImage = async (eventId) => {
        try {
            const response = await axios.get(`${this.baseUrl}/${eventId}/qrcode/image`, { withCredentials: true });
            return { success: true, message: response.data.message, data: response.data.data };
        } catch (error) {
            return { success: false, message: error.response?.data?.message || error.message, error };
        }
